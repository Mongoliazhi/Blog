...
module.exports = function (app) {
    ...
    app.get('/study/studyList', function (req, res) {
        ...
        if (req.query.val) {
            ...
            console.log(val)
            db.query('SELECT * FROM study WHERE study_title like "%' + val + '%" or study_sketch like "%' + val + '%" order by  id desc', function (err, rows) {
                if (err) {
                    console.log(err);
                } else {
                    console.log(rows)
            ...
            db.query('select id,study_title,study_time from study where study_name="' + req.query.study_name + '" order by  id desc', function (err, rows) {
                if (err) {
                    console.log(err);
                } else {
                    console.log(rows)
